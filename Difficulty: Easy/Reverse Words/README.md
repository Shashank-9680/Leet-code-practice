...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input: </strong>str = i.like.this.program.very.much
...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input: </strong>str = pqr.mno
